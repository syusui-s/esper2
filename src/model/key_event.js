...
//   'ShiftLeft', 'keyZ', 'keyX', 'keyC', 'keyV', 'keyB', 'keyN', 'keyM', 'Comma', 'Period', 'Slash', 'IntlRo',
//   'ShiftRight', 'ControlLeft', 'MetaLeft', 'AltLeft', 'NonConvert', 'Space', 'Convert', 'KanaMode', 'AltRight',
//   // Other Keys
...
export class KeyEvent {
  ...
  static fromKeyboardEvent(keyboardEvent) {
    ...
    return new this(code, key, timeStamp, {
      ctrlKey,
      altKey,
      shiftKey,
      metaKey,
